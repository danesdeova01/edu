    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a class="btn btn-sm btn-primary" href="{{ route('admin.mahasiswa.create', ['id' => 1]) }}">Add Siswa</a>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        @if (!isset($item->kelas))
                                            <a href="{{ route('admin.mahasiswa.addKelas', ['id' => $item->id]) }}"
                                                class="btn btn-primary btn-sm">Add Kelas</a>
                                        @endif
                                        ...
                                        <form action="{{ route('admin.mahasiswa.destroy', $item->id) }}" method="POST"
                                            ...
                                            <button class="btn btn-danger btn-sm"
                                                onclick="return confirm('Yakin hapus?')">Delete Siswa</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
